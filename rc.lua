...
beautiful.wallpaper = "/home/ch/Dropbox/inspiration/nostromo.png"
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "1", "2", "www", "idea", "5", "6", "7", "8", "spotify" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "l", function() awful.spawn("xscreensaver-command -lock") end,
...
clientkeys = gears.table.join(
    ...
    awful.key({}, "Pause",      function (c) c:kill()                         end,
              {description = "close", group = "client"}),
